...
function Testimonials() {
  const items = [
    { name: "Ramesh Kumar", role: "Sold a 2BHK in Saidapet", quote: "Land Marvel sold my apartment in under 6 weeks at a price 8% above my expectation. Truly professional team." },
