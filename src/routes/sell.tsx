...
import { submitSellListing } from "@/lib/api/client";
...
function SellForm() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (description.length < 10) {
      toast.error("Please enter a longer property description");
      return;
    }
    ...
    setSubmitting(true);
    try {
      await submitSellListing(formData);
        ...
        >
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input id="name" name="name" required placeholder="Enter Your Full Name" className="h-12 rounded-xl" maxLength={100} />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="email" name="email" type="email" required placeholder="Enter Your Email Address" className="h-12 rounded-xl" maxLength={255} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-primary font-semibold">Phone Number</Label>
              <Input id="phone" name="phone" type="tel" required placeholder="Enter Your Phone Number" className="h-12 rounded-xl" maxLength={20} />
            </div>
          ...
          <div className="mt-10 flex justify-center">
            ...
            >
              {submitting ? "Submitting..." : "Submit Property Details"} <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </div>
        </form>
      </div>
