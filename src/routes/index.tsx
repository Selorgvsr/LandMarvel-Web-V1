...
function Hero() {
  return (
    <section id="top" className="relative min-h-[calc(100svh-5rem)] lg:min-h-[calc(100svh-6rem)] w-full overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-start md:justify-center pt-8 pb-12 sm:pt-10 sm:pb-14 lg:py-16 text-primary-foreground">
...
function About() {
  ...
  return (
    <section id="about" className="scroll-mt-24 lg:scroll-mt-28 py-20 sm:py-28 section-navy">
...
function BuySection() {
  return (
    <section id="services" className="scroll-mt-24 lg:scroll-mt-28 py-20 sm:py-28 section-gold overflow-hidden">
...
function Projects() {
  ...
  return (
    <section id="projects" className="scroll-mt-24 lg:scroll-mt-28 py-20 sm:py-28 section-gold">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
...
function FinalCTA() {
  return (
    <section id="contact" className="scroll-mt-24 lg:scroll-mt-28 py-20 sm:py-24 text-primary-foreground section-gold">
