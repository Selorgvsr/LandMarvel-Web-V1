      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1">
            ...
            <h2 className="mt-4 font-display text-3xl sm:text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-bold text-primary leading-tight">Sell Your Property Directly{"\u00a0"}<br/>to{"\u00a0"}Land Marvel</h2>
            <p className="mt-6 text-muted-foreground text-lg lg:text-xl leading-relaxed">
